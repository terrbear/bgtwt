...
jsGrowlMsg.prototype = {
  ...
  html: function(jsg){
    ...
    return '<table id="growl_flash_msg_'+this.id+'" class="jsgrowl_msg_container"'+
      ...
      ' onmouseout="'+jsg+'.outMsg('+this.id+');"'+
      ' style="right:'+this.right+'px;top:'+this.top+'px;">' +
      ...
      '</div></td><td class="jsg_side jsg_mr"></tr><tr><td class="jsg_corner jsg_bl"></td><td class="jsg_middle jsg_mb"></td><td class="jsg_corner jsg_br"></td></tr></table>';
  },
  setElement: function(){
    if (!(this.element)){
